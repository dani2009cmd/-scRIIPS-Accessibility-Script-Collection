...
Global Const $APP_VERSION = "v10.2 Lollipop Auto - no duplicate constants"
...
; Windows input constants are supplied by the AutoIt include files above.
; Do not redeclare them here: AutoIt reports "Can not redeclare a constant".
