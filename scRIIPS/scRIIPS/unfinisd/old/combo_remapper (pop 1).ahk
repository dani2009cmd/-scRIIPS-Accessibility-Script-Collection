...
; ---- SINGLE-KEY MOUSE TRIGGER ----
; K -> mouse scroll wheel up x5 (uses low-level mouse_event,
; more reliable for emulators/games that read raw input)
*k::{
