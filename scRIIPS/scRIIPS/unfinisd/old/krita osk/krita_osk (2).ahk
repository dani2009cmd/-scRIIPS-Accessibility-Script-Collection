...
; ---------------------- Bottom control row ----------------------
SnapBtn := MyGui.Add("Button", "x10 y178 w140 h30", "Snap to Bottom")
SnapBtn.OnEvent("Click", SnapToBottom)

TopChk := MyGui.Add("Checkbox", "x160 y182 w110 h22 cWhite Checked", "Always on Top")
TopChk.OnEvent("Click", ToggleAlwaysOnTop)

MyGui.Add("Text", "x290 y183 w60 cWhite", "Opacity:")
OpacitySlider := MyGui.Add("Slider", "x350 y178 w150 h30 Range80-255", CurrentOpacity)
OpacitySlider.OnEvent("Change", ChangeOpacity)

HideNote := MyGui.Add("Text", "x520 y183 cWhite", "F9 = show/hide    F10 = release Pan/held keys")

ExitBtn := MyGui.Add("Button", "x760 y178 w150 h30", "Exit")
