...
; --- Sensitivity: lowered overall - was firing too easily ---
Variation := 90  ; default tolerance (0-255), lowered from 150
VariationTriangle := 55  ; green (Triangle) tightened - was false-firing on other on-screen greens
VariationCross := 90  ; blue (Cross) loosened back to match default
