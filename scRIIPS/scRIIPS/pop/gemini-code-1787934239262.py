...
# Force Python to run inside the folder where this script lives
...
def main():
    try:
        ...
        if not json_files:
            log(
                "ERROR: No .json file found in this folder! Make sure your JSON file is in the same folder as this script."
            )
            return
        ...
        log("JSON loaded successfully. Processing text lines...")
        ...
        log(
            f"SUCCESS! Processed {count} sentences and protected button tags."
        )
        log(f"Saved new file to: {out_name}")
...
if __name__ == "__main__":
    main()
    print("\nCheck LOG.txt in your folder to see what happened.")
